"""Legacy Modernization Agent — Agent Orchestrator (Plan → Research → Execute → Validate → Respond)."""
...
class AgentOrchestrator:
    """Orchestrates the Legacy Modernization Agent through a multi-step pipeline.
