"""Legacy Modernization Agent - Main Agent Implementation."""
...
class LegacyModernizationAgentAgent:
    """
    ...
    def __init__(self):
        ...
        self.monolith_analysis_enabled = True
        self.microservice_extraction_enabled = True
        self.strangler_fig_enabled = True
        self.ddd_modeling_enabled = True
        self.data_migration_enabled = True
        self._tool_dispatch = {
            "analyze_monolith": self.tools.analyze_monolith,
            "identify_bounded_contexts": self.tools.identify_bounded_contexts,
            "generate_extraction_plan": self.tools.generate_extraction_plan,
            "generate_anti_corruption_layer": self.tools.generate_anti_corruption_layer,
            "generate_data_migration": self.tools.generate_data_migration,
            "assess_modernization_roi": self.tools.assess_modernization_roi,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['monolith_analysis', 'microservice_extraction', 'strangler_fig', 'ddd_modeling', 'data_migration'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            "analyze_monolith": ['analyze', 'monolith'],
            "identify_bounded_contexts": ['identify', 'bounded', 'contexts'],
            "generate_extraction_plan": ['generate', 'extraction', 'plan'],
            "generate_anti_corruption_layer": ['generate', 'anti', 'corruption', 'layer'],
            "generate_data_migration": ['generate', 'data', 'migration'],
            "assess_modernization_roi": ['assess', 'modernization', 'roi'],
        }
