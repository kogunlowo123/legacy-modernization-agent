"""Application configuration for Legacy Modernization Agent."""
...
class Settings(BaseSettings):
    ...
    app_name: str = Field(default="legacy-modernization-agent", description="Application name")
    ...
    database_url: str = Field(
        default="postgresql+asyncpg://postgres:postgres@localhost:5432/legacy_modernization_agent",
    ...
    opensearch_index: str = Field(default="legacy_modernization_agent_vectors", description="Index")
    ...
    mcp_server_name: str = Field(default="legacy-modernization-agent-mcp", description="MCP server name")

    a2a_discovery_url: str = Field(default="http://localhost:8500", description="A2A discovery URL")
    a2a_agent_id: str = Field(default="legacy-modernization-agent", description="A2A agent ID")
